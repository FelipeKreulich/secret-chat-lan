...
| `/panel [rooms\|off]` (Ctrl+P)    | Show several rooms **side by side** — each column wraps for its own width, and the focused one takes what you type                                                                                                                                                                     |
